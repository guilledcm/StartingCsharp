...
class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        string leerCifrado = File.ReadAllText("textoCifrado.txt");
        List<char> caracteres = cadena.ToCharArray().Distinct().ToList();
        Dictionary<char,int> repeticionesCaracteres = new Dictionary<char, int>();
        repeticionesCaracteres.TryGetValue.ForEach((elemento1, indice) =>
        {
